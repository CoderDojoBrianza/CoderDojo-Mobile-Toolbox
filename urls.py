...
urlpatterns = [
    ...
    path('liberatorie/<str:spec>/', views.liberatorie,
    ...
    path('tutorial/<int:tutorial_id>', views_tutorial.tutorial,
         name='tutorial'),
    path('spriteCategory/<int:category_id>/', views.spriteCategory,
         name='spriteCategory'),
    path('thanks_tutorial/', views_tutorial.thanks, name='thanks'),
    path('learningTopics/', views.learningTopics, name='learningTopics'),
    path('learningTopics/<int:topic_id>/', views_tutorial.tutorials,
         name='tutorials'),
    path('events/', views.events, name='events'),
    path('eventDetails/<int:event_id>', views.eventDetails,
         name='eventDetails'),
    path('eventDetails/check_in_out/<int:event_id>', views.eventCheckInOut,
         name='eventCheckInOut'),
    # path('learningTopics/<int:topic_id>/<int:material_level>',
    #      views_tutorial.tutorials, name='learningTopicsWithLevelFilter'),
    path('login/',
    ...
    path('logout/',
         auth_views.LogoutView.as_view(
             next_page=reverse_lazy('coderdojomobile:index')),
         name="logout"),
